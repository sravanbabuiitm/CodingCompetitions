...
public class CaversBFS_IO {
	public static void main(String args[]) throws Exception{
		char color[][] = getAdjacenyMatrix();
	...
	private static char[][] getAdjacenyMatrix() throws Exception {
		@SuppressWarnings("resource")
		Scanner br = new Scanner(System.in);
		int noChambers = Integer.parseInt(br.nextLine());
